  ...
  return (
    ...
    >
      <ProFormText
        ...
        placeholder={''}
        width="sm"
        label={<FormattedMessage id="pages.accounts.nickName" />}
      />
      <ProForm.Group>
        <ProFormText
          rules={[
          ...
          name="prefix"
          disabled={!!item.id}
          label={<FormattedMessage id="pages.accounts.agentCode" />}
        />
        {!!item.id ? (
          ''
        ) : (
      ...
      <ProForm.Group>
        ...
        {!!item.id ? (
          ...
          <ProFormDigit
            ...
            placeholder={''}
            name="balance"
            label={<FormattedMessage id="pages.accounts.balance" />}
          />
        )}
      </ProForm.Group>
      <ProFormText
      ...
      <ProFormText
        ...
        label={<FormattedMessage id="pages.accounts.email" />}
        placeholder=""
      />
    </DrawerForm>
  );
